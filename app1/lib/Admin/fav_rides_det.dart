...
class fav_rides_det extends StatefulWidget {
  const fav_rides_det({super.key});

  @override
  _MoreTripHisstate createState() => _MoreTripHisstate();
}
class _MoreTripHisstate extends State<fav_rides_det> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:const Text("favourite Ride Detail Page"),
